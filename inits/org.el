...
(defun my/org-babel-language-available-p (language)
  "Return non-nil when the executables needed by LANGUAGE are installed."
  (cond
   ((eq language 'python)
    (executable-find org-babel-python-command))
   ((eq language 'java)
    (and (executable-find "java")
...
(defun my/org-babel-language-enabled-p (language)
  "Return non-nil when LANGUAGE is configured and executable here."
  (and (cdr (assq language my/org-babel-languages))
       (my/org-babel-language-available-p language)))

(defun my/org-babel-available-languages ()
  "Return configured Org Babel languages that can run here."
  (seq-filter (lambda (language)
                (my/org-babel-language-enabled-p (car language)))
...
(use-package org
  ...
  (org-babel-do-load-languages 'org-babel-load-languages
                               (my/org-babel-available-languages))
